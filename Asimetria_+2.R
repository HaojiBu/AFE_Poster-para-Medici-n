...
F1 <- rnonnorm(n, mean = 0, sd = 1, skew = +2)$dat
F2 <- rnonnorm(n, mean = 0, sd = 1, skew = +2)$dat
...
i1 <- (Lambda1 * F1) + (Error1 * rnonnorm(n, mean = 0, sd = 1, skew = +2)$dat)
i2 <- (Lambda1 * F1) + (Error1 * rnonnorm(n, mean = 0, sd = 1, skew = +2)$dat)
i3 <- (Lambda1 * F1) + (Error1 * rnonnorm(n, mean = 0, sd = 1, skew = +2)$dat)
i4 <- (Lambda1 * F1) + (Error1 * rnonnorm(n, mean = 0, sd = 1, skew = +2)$dat)
i5 <- (Lambda1 * F1) + (Error1 * rnonnorm(n, mean = 0, sd = 1, skew = +2)$dat)

i6 <- (Lambda2 * F2) + (Error2 * rnonnorm(n, mean = 0, sd = 1, skew = +2)$dat)
i7 <- (Lambda2 * F2) + (Error2 * rnonnorm(n, mean = 0, sd = 1, skew = +2)$dat)
i8 <- (Lambda2 * F2) + (Error2 * rnonnorm(n, mean = 0, sd = 1, skew = +2)$dat)
i9 <- (Lambda2 * F2) + (Error2 * rnonnorm(n, mean = 0, sd = 1, skew = +2)$dat)
i10 <- (Lambda2 * F2) + (Error2 * rnonnorm(n, mean = 0, sd = 1, skew = +2)$dat)

### Se convierten a ordinales de 5 categorias ###

breaks5 <- c(-Inf, 0, 1, 2, 3, Inf)
