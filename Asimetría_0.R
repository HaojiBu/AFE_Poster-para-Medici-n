...
i1 <- (Lambda1 * F1) + (Error1 * rnorm(n))
i2 <- (Lambda1 * F1) + (Error1 * rnorm(n))
i3 <- (Lambda1 * F1) + (Error1 * rnorm(n))
i4 <- (Lambda1 * F1) + (Error1 * rnorm(n))
i5 <- (Lambda1 * F1) + (Error1 * rnorm(n))

i6 <- (Lambda2 * F2) + (Error2 * rnorm(n))
i7 <- (Lambda2 * F2) + (Error2 * rnorm(n))
i8 <- (Lambda2 * F2) + (Error2 * rnorm(n))
i9 <- (Lambda2 * F2) + (Error2 * rnorm(n))
i10 <- (Lambda2 * F2) + (Error2 * rnorm(n))
